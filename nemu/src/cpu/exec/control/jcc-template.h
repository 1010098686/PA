...
static void do_execute()
{
   ...
   switch(ops_decoded.opcode)
   {
     ...
     case 0x187:flag=(cpu.eflags.CF==0 && cpu.eflags.ZF==0);break;
     case 0x73:flag=(cpu.eflags.CF==0);break;
     case 0x183:flag=(cpu.eflags.CF==0);break;
     case 0xe3:flag=(cpu.ecx==0);break;
     case 0x74:flag=(cpu.eflags.ZF==1);break;
     case 0x184:flag=(cpu.eflags.ZF==1);break;
     case 0x7f:flag=(cpu.eflags.ZF==0 && cpu.eflags.SF==cpu.eflags.OF);break;
     case 0x18f:flag=(cpu.eflags.ZF==0 && cpu.eflags.SF==cpu.eflags.OF);break;
     case 0x7d:flag=(cpu.eflags.SF==cpu.eflags.OF);break;
     case 0x18d:flag=(cpu.eflags.SF==cpu.eflags.OF);break;
     case 0x7c:flag=(cpu.eflags.SF!=cpu.eflags.OF);break;
     case 0x18c:flag=(cpu.eflags.SF!=cpu.eflags.OF);break;
     case 0x7e:flag=(cpu.eflags.ZF==1 || cpu.eflags.SF!=cpu.eflags.OF);break;
     case 0x18e:flag=(cpu.eflags.ZF==1 || cpu.eflags.SF!=cpu.eflags.OF);break;
     case 0x76:flag=(cpu.eflags.CF==1 || cpu.eflags.ZF==1); break;
     case 0x186:flag=(cpu.eflags.CF==1 || cpu.eflags.ZF==1); break;
     case 0x72:flag=(cpu.eflags.CF==1);break;
     case 0x182:flag=(cpu.eflags.CF==1);break;
     case 0x75:flag=(cpu.eflags.ZF==0);break;
     case 0x185:flag=(cpu.eflags.ZF==0);break;
     case 0x71:flag=(cpu.eflags.OF==0);break;
     case 0x181:flag=(cpu.eflags.OF==0);break;
     case 0x7b:flag=(cpu.eflags.PF==0);break;
     case 0x18b:flag=(cpu.eflags.PF==0);break;
     case 0x79:flag=(cpu.eflags.SF==0);break;
     case 0x189:flag=(cpu.eflags.SF==0);break;
     case 0x70:flag=(cpu.eflags.OF==1);break;
     case 0x180:flag=(cpu.eflags.OF==1);break;
     case 0x7a:flag=(cpu.eflags.PF==1);break;
     case 0x18a:flag=(cpu.eflags.PF==1);break;
     case 0x78:flag=(cpu.eflags.SF==1);break;
     case 0x188:flag=(cpu.eflags.SF==1);break;
     default :flag=0;
     }
     if(flag)
     {
